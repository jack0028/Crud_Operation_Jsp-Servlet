            ...
            <div class="card-body">
                ...
                <fieldset class="form-group">
                 ...
                 <fieldset class="form-group">
                    ...
                    <input type="text" value="<c:out value='${user.contact}' default=''/>'" class="form-control" name="contact">
                </fieldset>

                <fieldset class="form-group">
                    <label>User Otp</label>
                    <input type="number" value="<c:out value='${user.otp}' default=''/>'" class="form-control" name="otp">
                </fieldset>
                 <fieldset class="form-group">
